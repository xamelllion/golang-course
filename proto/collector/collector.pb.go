...
const file_proto_collector_collector_proto_rawDesc = "" +
	...
	"\frepositories\x18\x01 \x03(\v2 .collector.GetRepositoryResponseR\frepositories2\x91\x02\n" +
	"\x10CollectorService\x12R\n" +
	"\rGetRepository\x12\x1f.collector.GetRepositoryRequest\x1a .collector.GetRepositoryResponse\x12p\n" +
	"\x17GetSubscribedRepository\x12).collector.GetSubscribedRepositoryRequest\x1a*.collector.GetSubscribedRepositoryResponse\x127\n" +
...
var file_proto_collector_collector_proto_goTypes = []any{
	...
	(*GetSubscribedRepositoryRequest)(nil),  // 4: collector.GetSubscribedRepositoryRequest
	(*GetSubscribedRepositoryResponse)(nil), // 5: collector.GetSubscribedRepositoryResponse
	(*timestamppb.Timestamp)(nil),           // 6: google.protobuf.Timestamp
}
var file_proto_collector_collector_proto_depIdxs = []int32{
	6, // 0: collector.GetRepositoryResponse.create_date:type_name -> google.protobuf.Timestamp
	1, // 1: collector.GetSubscribedRepositoryResponse.repositories:type_name -> collector.GetRepositoryResponse
	0, // 2: collector.CollectorService.GetRepository:input_type -> collector.GetRepositoryRequest
	4, // 3: collector.CollectorService.GetSubscribedRepository:input_type -> collector.GetSubscribedRepositoryRequest
	2, // 4: collector.CollectorService.Ping:input_type -> collector.PingRequest
	1, // 5: collector.CollectorService.GetRepository:output_type -> collector.GetRepositoryResponse
	5, // 6: collector.CollectorService.GetSubscribedRepository:output_type -> collector.GetSubscribedRepositoryResponse
	3, // 7: collector.CollectorService.Ping:output_type -> collector.PingResponse
